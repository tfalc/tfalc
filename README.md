...
Senior Java Engineer | Backend & Cloud, based in Rio de Janeiro, Brazil 🇧🇷

- 🔭 Currently expanding into Python (FastAPI) building a Disaster Recovery platform on AWS (DMS, Bedrock, Bedrock Guardrails, Bedrock AgentCore)
- ☕ 4+ years building Java/Spring Boot microservices, REST APIs, and distributed cloud-native systems
- ☁️ Strong background in AWS automation (ECS, Lambda, EKS, CloudFormation) and observability (Datadog, Splunk, Grafana)
- 🤖 Built internal Claude-based tooling to catch code gaps in reviews before production
- 🎓 AWS Certified Solutions Architect – Associate
- 🌍 Advanced (C1) English — experienced working with global, cross-functional teams
